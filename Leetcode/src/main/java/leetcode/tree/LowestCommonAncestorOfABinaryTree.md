...
According to the [definition of LCA on Wikipedia](https://en.wikipedia.org/wiki/Lowest_common_ancestor): “The lowest common ancestor is defined between two nodes p and q as the lowest listNode in T that has both p and q as descendants (where we allow **a listNode to be a descendant of itself**).”
...
Output: 5
Explanation: The LCA of nodes 5 and 4 is 5, since a listNode can be a descendant of itself according to the LCA definition.
```
